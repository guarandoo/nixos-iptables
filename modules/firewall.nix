{
  ...
  mapRule = active: rule:
    ...
    (flatten [
      ...
      (concatMapStringsSep " " (module: "-m ${module.module} ${mapArguments matcherSchemas module.module module.options} ${optionalString (!isNull module.extraArgs) module.extraArgs}") rule.modules)
